...
const GAME_CONFIG = {
  ...
  MAX_SYNC_QUEUE_SIZE: 100, // Max operations in sync queue
  SYNC_TIMEOUT_MS: 10000, // 10 second timeout for sync requests
  MIN_SYNC_INTERVAL_MS: 1000, // Minimum time between syncs (rate limiting)
  MAX_BATCH_OPERATIONS: 50, // Maximum operations in a single batch
...
const DAILY_BONUS_CONFIG = {
  BASE_AMOUNT: 100, // Base daily bonus amount
  MAX_STREAK: 7, // Maximum streak days
  MIN_HOURS_BETWEEN_BONUSES: 20, // Minimum hours between bonus claims
  STREAK_RESET_HOURS: 36, // Hours after which streak resets
  STREAK_MULTIPLIERS: [1, 1.5, 2, 2.5, 3, 4, 7] // Multipliers for days 1-7
};
